...
public class ArealObjectTransaction extends EnvironmentObjectTransaction {

  /** Specifies the physical location (a collection of points) that defines the object */
