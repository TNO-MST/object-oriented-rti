...
/**
 * The MinefieldData object class provides data about collections of mines within a minefield on an
 * individual mine basis.
 */
public class MinefieldData extends EmbeddedSystem {
  ...
  /**
   * Specifies the primary and secondary fuse and anti-handling device for each mine in a collection
   * of mines
   */
  MineFusingStruct[] Fusing;

  /** Specifies the real-world (UTC) emplacement time of each mine in a collection of mines */
  ...
  /**
   * Specifies the location of the mine relative to the minefield location for each mine in a
   * collection of mines
   */
   ...
   * minefield Coordinate System for each mine in a collection of mines
   */
  OrientationStruct[] MineOrientation;

  /**
   * Specifies the type of mine for the collection of mines contained within the MinefieldData
   * object
   */
  EntityTypeStruct MineType;

  /**
   * Specifies the number of trip detonation wires that exist for each mine in a collection of mines
   */
  byte[] NumberTripDetonationWires;

  /** Specifies the number of vertices for each trip wire of each mine in a collection of mines */
  ...
  /**
   * Specifies the temperature difference between the mine and the surround soil in degrees
   * Centigrade
   */
