 ...
 * that a federate sets the values of specified data to specified values. The Simulation Manager
 * federate specifies the acknowledgement protocol to be used.
 */
public class SetDataR extends SetData {
