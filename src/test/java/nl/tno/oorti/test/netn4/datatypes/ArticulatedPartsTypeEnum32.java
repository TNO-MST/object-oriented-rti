...
public enum ArticulatedPartsTypeEnum32 {
  ...
  LeftStabilator__StabilatorNumber1__(1408),
  RightStabilator__StabilatorNumber2__(1440),
  LeftRuddervator__RuddervatorNumber1__(1472),
  RightRuddervator__RuddervatorNumber2__(1504),
  LeftLeadingEdgeFlap__Slat(1536),
  RightLeadingEdgeFlap__Slat(1568),
  Periscope(2048),
  GenericAntenna(2080),
  Snorkel(2112),
  ...
  LandingGear___Nose(3584),
  LandingGear___LeftMain(3616),
  LandingGear___RightMain(3648),
  LeftSide__SecondaryWeaponBayDoors(3680),
  RightSide__SecondaryWeaponBayDoors(3712),
  ...
  CargoDoor(7648),
  CargoRamp(7680),
  Air___to___AirRefuelingBoom(7712);

  private final int value;

  private final int[] values;

  private ArticulatedPartsTypeEnum32(int... values) {
    this.value = values[0];
    this.values = values;
  }
