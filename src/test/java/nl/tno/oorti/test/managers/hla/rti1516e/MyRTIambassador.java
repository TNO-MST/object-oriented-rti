...
/**
 * A bare bone RTI ambassador with enough interfaces and methods implemented to perform the
 * Serializer tests.
 *
 * @author bergtwvd
 */
public class MyRTIambassador implements RTIambassador {
  ...
  MyAttributeHandleValueMapFactory myAttributeHandleValueMapFactory =
      new MyAttributeHandleValueMapFactory();
  MyParameterHandleValueMapFactory myParameterHandleValueMapFactory =
      new MyParameterHandleValueMapFactory();
  ...
  Map<ObjectInstanceHandle, String> objectInstanceHandle2Name = new HashMap<>();
  ...
  public void connect(
      ...
      throws ConnectionFailed,
          ...
          RTIinternalError { this.federateReference = federateReference; }
  ...
  public ObjectInstanceHandle registerObjectInstance(ObjectClassHandle theClass)
    ...
    String name = "MyName-" + this.nameCounter++;
    this.name2ObjectInstanceHandle.put(name, h);
    this.objectInstanceHandle2Name.put(h, name);
    return h;
  }
  ...
  public ObjectInstanceHandle registerObjectInstance(
    ...
    this.objectInstanceHandle2Name.put(h, theObjectName);
    return h;
  }
  ...
  public void deleteObjectInstance(ObjectInstanceHandle objectHandle, byte[] userSuppliedTag)
      throws DeletePrivilegeNotHeld,
          ...
          NotConnected,
          RTIinternalError {
    String name = this.objectInstanceHandle2Name.remove(objectHandle);
    if (name != null) {
      this.name2ObjectInstanceHandle.remove(name);
    } else throw new ObjectInstanceNotKnown(objectHandle.toString());
  }
  ...
  public ObjectInstanceHandle getObjectInstanceHandle(String theName)
      throws ObjectInstanceNotKnown, FederateNotExecutionMember, NotConnected, RTIinternalError {
    ObjectInstanceHandle theHandle = this.name2ObjectInstanceHandle.get(theName);
    if (theHandle == null) throw new ObjectInstanceNotKnown(theName);
    else return theHandle;
  }

  @Override
  public String getObjectInstanceName(ObjectInstanceHandle theHandle)
      throws ObjectInstanceNotKnown, FederateNotExecutionMember, NotConnected, RTIinternalError {
    String name = this.objectInstanceHandle2Name.get(theHandle);
    if (name == null) throw new ObjectInstanceNotKnown(theHandle.toString());
    else return name;
  }
