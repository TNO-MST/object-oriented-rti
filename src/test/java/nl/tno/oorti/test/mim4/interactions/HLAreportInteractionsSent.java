 ...
 * undefined value.
 */
public class HLAreportInteractionsSent extends HLAreport {

  /** Transportation type used in sending interactions */
  String HLAtransportation;

  /**
   * List of interaction counts. Each interaction count consists of an interaction class handle and
   * the number of interactions of that class. This information shall reflect related DDM usage.
