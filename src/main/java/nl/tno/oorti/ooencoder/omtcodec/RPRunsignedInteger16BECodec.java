 ...
 * @author bergtwvd
 */
class RPRunsignedInteger16BECodec extends HLAunsignedInteger16BECodec {

  RPRunsignedInteger16BECodec(OmtCodecFactory codecFactory, Type type, BasicData dt)
