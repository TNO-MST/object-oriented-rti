...
## Use the OORTI
The use of the OORTI library in an application requires an HLA RTI implementation from an RTI provider. Providers include [OneArc](https://onearc.com), [VTMaK](https://www.mak.com), and [Portico](https://github.com/openlvc/portico). The RTI libraries from a provider must be included with your application in order to use the OORTI library.
...
- [Create Maven RTI artifacts for the Pitch and MaK RTI](doc/Mavenize.md)
